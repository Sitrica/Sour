...
import com.sitrica.core.bukkit.sounds.SoundPlayer;
...
import com.sitrica.core.bukkit.command.AbstractCommand.ReturnType;
import com.sitrica.core.bukkit.messaging.MessageBuilder;
...
public class CommandHandler implements CommandExecutor {
	...
	public CommandHandler(SourBukkitPlugin instance, Class<? extends AbstractCommand> main, String... commandPackages) {
		Validate.notNull(main);
		this.main = main;
		this.instance = instance;
		Utils.getClassesOf(instance, AbstractCommand.class, commandPackages).forEach(clazz -> {
			try {
				commands.add(clazz.getConstructor(SourBukkitPlugin.class).newInstance(instance));
