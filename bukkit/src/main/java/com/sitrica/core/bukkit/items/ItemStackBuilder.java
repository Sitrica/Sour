//package com.sitrica.core.bukkit.items;
//
...
//import com.sitrica.core.bukkit.utils.DeprecationUtils;
...
//	}
//
//	public ItemStackBuilder(SourBukkitPlugin instance, String node) {
...
//	 */
//	public ItemStackBuilder(SourBukkitPlugin instance, ConfigurationSection section) {
//		this.instance = instance;
...
//	 * @return The ItemStackBuilder for chaining.
//	 */
//	public ItemStackBuilder fromConfiguration(ConfigurationNode section) {
//		this.section = section;
//		if (node != null)
//			this.section = section.node(node);
//		return this;
//	}
//
//	/**
...
//	 * @return The ItemStackBuilder for chaining.
//	 */
//	public ItemStackBuilder glowingIf(Supplier<Boolean> glowing) throws IllegalAccessException {
//		if (section == null) {
//			if (node == null)
...
//					.orElse(instance.getConfiguration().orElseThrow(() -> new IllegalAccessException("Plugin had no inventories.yml")))
//					.node(node);
//		}
//		if (!section.node("glowing").getBoolean(true))
//			return this;
...
//	 * @return The ItemStackBuilder for chaining.
//	 */
//	public ItemStackBuilder setConfigurationSection(ConfigurationNode section) {
//		this.section = section;
//		return this;
//	}
//
...
//	 */
//	public ItemStack build() throws IllegalAccessException {
//		if (section == null) {
//			if (node == null) {
...
//		String matName = section.node("material").getString("STONE");
//		Material material = Fallback.materialAttempt(applyPlaceholders(matName), "STONE");
