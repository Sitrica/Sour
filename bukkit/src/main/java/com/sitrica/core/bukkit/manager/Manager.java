...
public abstract class Manager implements Listener {
	 ...
	 */
	public <T, S> Database<T> getNewDatabase(SourBukkitPlugin instance, String tableNode, Class<T> type) throws IllegalAccessException {
		return getNewDatabase(instance, tableNode, type, new HashMap<>());
	}

	@SuppressWarnings("unchecked")
	public <T, S> Database<T> getNewDatabase(SourBukkitPlugin instance, String tableNode, Class<T> type, Map<Type, Serializer<?>> serializers) throws IllegalAccessException {
	...
	@SuppressWarnings("unchecked")
	protected <T> Database<T> getFileDatabase(SourBukkitPlugin instance, String table, Class<T> type, Map<Type, Serializer<?>> serializers) {
		if (databases.containsKey(type))
