...
public class MessageBuilder {
	 ...
	 */
	public MessageBuilder(SourBukkitPlugin instance, String... nodes) {
	 ...
	 */
	public MessageBuilder(SourBukkitPlugin instance, boolean prefix, String node, ConfigurationSection section) {
	 ...
	 * @param nodes The configuration nodes from the messages.yml
	 */
	public MessageBuilder(SourBukkitPlugin instance, boolean prefix, String... nodes) {
		this.instance = instance;
		this.prefix = prefix;
		this.nodes = nodes;
	}
