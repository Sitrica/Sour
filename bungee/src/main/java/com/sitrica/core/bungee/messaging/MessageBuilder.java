...
public class MessageBuilder {
	 ...
	 */
	public MessageBuilder(SourBungeePlugin instance, String... nodes) {
	 ...
	 */
	public MessageBuilder(SourBungeePlugin instance, boolean prefix, String node, Configuration section) {
	 ...
	 * @param nodes The configuration nodes from the messages.yml
	 */
	public MessageBuilder(SourBungeePlugin instance, boolean prefix, String... nodes) {
		this.instance = instance;
		this.prefix = prefix;
		this.nodes = nodes;
	}
